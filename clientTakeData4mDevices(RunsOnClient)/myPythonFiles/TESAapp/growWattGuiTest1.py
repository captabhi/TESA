...
labelVac=Label(root,text=" Vac : "+ str(Vac1)+"V / "+str(Vac2)+"V / "+str(Vac3)+"V",fg="blue",bg="white")
labelVac.grid(padx=10,pady=5,ipadx=0,row=5,column=0)

labelVpv=Label(root,text=" Vpv : "+ str(Vpv1)+"V / "+str(Vpv2)+"V",fg="red",bg="white")
labelVpv.grid(padx=10,pady=5,row=6,column=0)

labelIac=Label(root,text=" Iac : "+ str(Iac1)+"A / "+str(Iac2)+"A / "+str(Iac3)+"A",fg="green",bg="white")
labelIac.grid(padx=10,pady=5,row=7,column=0)

labelIpv=Label(root,text=" Ipv : "+ str(Ipv1)+"A / "+str(Ipv2)+"A",fg="magenta",bg="white")
labelIpv.grid(padx=10,pady=5,row=8,column=0)

labelPnow=Label(root,text=" Pnow : "+str(Pnow)+"kW",fg="yellow",bg="white")
labelPnow.grid(padx=10,pady=5,ipadx=0,row=5,column=1)

labelEtoday=Label(root,text=" Etoday : "+str(Etoday)+"kW",fg="brown",bg="white")
labelEtoday.grid(padx=10,pady=5,ipadx=0,row=6,column=1)

labelEall=Label(root,text=" Eall : "+str(Eall)+"kW",fg="purple",bg="white")
