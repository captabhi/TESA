...
class mainWindow(Frame):
    ...
    f.write("Time,Vac1,Vac2,Vac3,Vpv1,Vpv2,Iac1,Iac2,Iac3,Ipv1,Ipv2,Pnow,Etoday,Eall\n")
    f.close() 
    deviceId=1
    Time=[]
    Vac1=0
...
####
    ...
    def makeCSVfile(self):
        ...
        if(str(self.today)==str(self.lastday)):
            ...
            self.f=open(self.filePath+str(self.today)+".csv","w")
            self.f.write("Time,Vac1,Vac2,Vac3,Vpv1,Vpv2,Iac1,Iac2,Iac3,Ipv1,Ipv2,Pnow,Etoday,Eall\n")
        self.lastday=self.today
